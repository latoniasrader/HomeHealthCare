package home.health.care.controller.error;
...
@Slf4j
public class GloberErrorHandler {
	private enum LogStatus{
		...
		public Map<String, String> handleDuplicateKeyException(DuplicateKeyException ex, WebRequest webRequest){
			return buildExceptionMessage(ex, HttpStatus.CONFLICT, webRequest, LogStatus.MESSAGE_ONLY );	
		}
				private Map<String, String> buildExceptionMessage(Exception ex, HttpStatus status,
